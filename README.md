...
| [2026-06-29 Qwen LoRA smoke run](runs/2026-06-29-qwen-lora-smoke/README.md) | Qwen2.5 0.5B LoRA smoke test, TRL compatibility fix, and base vs adapter comparison | Complete |
| [2026-06-29 profiling record run](runs/2026-06-29-profiling-record/README.md) | Parse llama.cpp logs, run one Q4 profiling sample, and record GPU monitor caveats | Complete |
| [2026-06-29 final agent review run](runs/2026-06-29-final-agent-review/README.md) | Local Agent planner smoke test, policy validation failure, and final report draft | Complete |
